...
class Usuario:
    def __init__(self, id_usuario, nome_completo, data_nascimento, email, senha_hash, data_cadastro, atualizado_em, ativo, tipo_usuario, telefone, cpf_cnpj):
...
class Carro:
    def __init__(self, id_carro, marca, modelo, ano_modelo, ano_fabricacao, versao, cor, cambio, combustivel, categoria, quilometragem, estado, cidade, preco_compra, preco_venda, licenciado, criado_em, atualizado_em, placa, ativo, renavam):
...
class Moto:
    def __init__(self, id_moto, marca, modelo, ano_modelo, ano_fabricacao, versao, cor, marchas, partida, tipo_motor, cilindradas, freio_dianteiro_traseiro, refrigeracao, estado, cidade, quilometragem, preco_compra, preco_venda, licenciado, criado_em, atualizado_em, placa, ativo, alimentacao, renavam):
